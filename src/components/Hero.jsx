  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-4 pb-12 text-center md:pb-16">
        ...
        {/* TEXTO */}
        <p className="mt-5 max-w-3xl text-sm leading-7 text-white/95 sm:text-base md:mt-8 md:text-xl md:leading-9">
        ...
        {/* BOTONES */}
        <div className="mt-6 flex w-full max-w-xs flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center md:mt-10">
          
          {/* SOLO MÓVIL */}
          <a
            href="tel:637883587"
            className="inline-flex justify-center rounded-xl bg-white px-6 py-3 text-base font-bold text-black md:hidden"
          >
            Llamar ahora
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#E4B525] px-6 py-3 text-base font-bold text-black transition hover:bg-[#C89B00]"
          >
            <img
              src="/whatsapp.png"
              alt="WhatsApp"
          ...
          <a
            href="#servicios"
            className="hidden items-center justify-center rounded-xl bg-white px-6 py-3 text-base font-semibold text-black transition hover:bg-[#f3f3f3] sm:inline-flex"
          >
            Nuestros servicios
          </a>
        </div>
        ...
        <a
          href="#servicios"
          className="mt-14 flex flex-col items-center text-white md:mt-24"
        >
          <span className="text-sm font-medium text-white">Descubre más</span>
          <span className="mt-2 text-xl text-white">⌄</span>
        </a>
